...
const gridTemplate = "1fr 150px 100px 100px";
...
<template>
  <TimerEditForm v-if="toEdit" :original-timer="toEdit" @cancel="toEdit = undefined" />
  ...
  <div id="timers-page">
    <div id="timers-page-controls">
      <div id="timers-page-controls__search">
        ...
        <FormButton
          type="button"
          @click="timers.queryFilter = ''">clear</FormButton>
      </div>
      ...
      <TableBody>
        <template v-if="timers.timers.length">
          <TableRow
            ...
            <TableCell centered>
              <FormButton type="button" smaller @click="toEdit = timer">edit</FormButton>
            </TableCell>
            <TableCell centered>
              <FormButton type="button" smaller @click="timers.handleDelete(timer.id)">delete</FormButton>
            </TableCell>
          </TableRow>
        </template>
