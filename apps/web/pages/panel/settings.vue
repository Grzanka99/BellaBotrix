...
const aiModelsOptions = computed<TSelectOption<string>[]>(() => {
  const res = modelsStore.enabled.map((el) => ({
    value: el.name,
    displayName: `${el.name}, ${el.provider}`,
  }));
...
<template>
  <div id="settings-page">
    ...
    <SettingsGroup
      group-name="Trigger Words"
      v-if="triggerWords?.enabled"
    >
      <SingleSetting
        name="enabled"
        :option="triggerWords.enabled"
      >
        <FancyToggle
    ...
    >
      <SettingsGroup
        group-name="Ollama AI Reponses"
        v-if="ollamaAI"
      >
        <SingleSetting
          name="enabled"
          :option="ollamaAI.enabled"
        >
          <FancyToggle
    ...
    >
      <SettingsGroup
        group-name="Automod AI"
        v-if="automod"
      >
        <SingleSetting
          name="enabled"
          :option="automod.enabled"
        >
          <FancyToggle
